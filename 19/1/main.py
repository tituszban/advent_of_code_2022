...
class Blueprint:
    ...
    def get_quality_level(self, steps: int = 24):
        ...
        return best_state.resources[0] * self._id
...
def main():
    ...
    print(sum([b.get_quality_level() for b in blueprints]), 33)
    ...
    print(sum([b.get_quality_level() for b in blueprints]))
